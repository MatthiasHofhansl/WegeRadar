...
class WegeRadar:
    ...
    def start_action(self) -> None:
        ...
        scrollbar_left = tk.Scrollbar(container, orient="vertical",
        ...
        for last, first in names:
            ...
            lbl = tk.Label(left_inner, text=short, font=("Arial", 12),
    ...
    def on_name_click(self, last: str, first: str) -> None:
        ...
        tk.Label(head,
                 ...
                 font=("Arial", 14, "bold"),
                 bg="white", anchor="w").pack(side="left", padx=10, pady=5)
        tk.Button(head, text="✖", font=("Arial", 12, "bold"),
                  fg="red", bg="white", bd=0,
                  command=lambda: [w.destroy() for w in self.static_frame.winfo_children()
                                   for w in self.list_inner.winfo_children()])\
    ...
    def show_stops(self, loader: tk.Toplevel, prog: ttk.Progressbar,
        ...
        tk.Label(self.static_frame, text=f"Datum der GPX-Datei: {date}",
                 font=("Arial", 14, "bold"), bg="white", anchor="w")\
            .pack(fill="x", padx=10, pady=(2, 1))

        tk.Frame(self.static_frame, bg="black", height=2)\
            .pack(fill="x", pady=(0, 10))

        if not places:
            tk.Label(self.list_inner, text="Keine Orte gefunden.",
        ...
        for idx, p in enumerate(places, 1):
            ...
            tk.Label(self.list_inner, text=ort_text, font=("Arial", 12),
                     bg="white", anchor="w",
            ...
            if idx < len(places):
                ...
                tk.Label(self.list_inner, text=weg_text,
